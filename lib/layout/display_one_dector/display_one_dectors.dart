...
import '../../modules/users/doctors.dart';
import '../../shared/network/local/data_time.dart';

class DisplayOneDoctors extends StatefulWidget {
  @override
  Doctors doctor;
  DisplayOneDoctors(this.doctor);
  State<DisplayOneDoctors> createState() => _DisplayOneDoctorState();
}

class _DisplayOneDoctorState extends State<DisplayOneDoctors> {
