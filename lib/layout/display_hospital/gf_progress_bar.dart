...
class GFProgressBar extends StatefulWidget {
  ...
  GFProgressBar({
    ...
    this.reverse = false,
    // this.mask=MaskFilter.blur(_style, _sigma),
    this.type = GFProgressType.linear,
    this.progressHeadType=GFProgressHeadType.square,
    this.lineHeight = 5.0,
    this.width,
    ...
    this.clipLinearGradient = false,  this.mask,
  })  {
...
class _GFProgressBarState extends State<GFProgressBar>
  ...
  late AnimationController _animationController, circularAnimationController;
  late Animation _animation, circularAnimation;
